...
def choosing_acquisition(filename_sw):
	...
	for ii in poss_files:
		...
		if round(acq_len/60, 1) > 5:
			acq.append(int(ii[idx1+1:idx2]))
			print('Added acq ' + ii)
		elif round(acq_len/60, 1) <= 5:
			print('Ok, not adding ' + ii)
		else: 
...
<<<<<<<< HEAD:neuroscience_sleep_scoring/extract_data_kg.py
...
>>>>>>>> ef4bb470eebac275a66731355c21f4d25b3ad57c:neuroscience_sleep_scoring/extract_data.py
	'''
